...
app.config['PERMANENT_SESSION_LIFETIME'] = datetime.timedelta(hours=int(os.getenv('SESSION_TIMEOUT_HOURS', 24)))
# Constants
DB_PATH = os.getenv('DATABASE_URL', 'sqlite:///GGU DBA ET Learner Journey.db').replace('sqlite:///', '')
